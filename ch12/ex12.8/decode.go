...
sexpr.Decoder type that, like json.Decoder, allows a sequence of values to be
decoded from an io.Reader. Change sexpr.Unmarshal to use this new type.
...
func (d *Decoder) Decode(v interface{}) (err error) {
	if d.l == nil {
		d.l = &lexer{scan: scanner.Scanner{Mode: scanner.GoTokens}}
		d.l.scan.Init(d.r)
		d.l.next()
	}
	if d.l.token == scanner.EOF {
		return io.EOF
	}
	defer func() {
