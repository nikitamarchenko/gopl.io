...
by adding more values to palette and then displaying them by changing the
...
var palette = []color.Color{
	color.Black,
	color.RGBA{0x00, 0xff, 0x2b, 0xff},
	color.RGBA{54, 186, 1, 0xff},
	color.RGBA{0, 154, 34, 0xff},
	color.RGBA{0, 154, 34, 0xff},
	color.RGBA{0, 154, 34, 0xff},
	color.RGBA{0, 154, 34, 0xff}}
